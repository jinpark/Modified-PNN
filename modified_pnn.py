...
csv1 = list(csv.reader(open('traindatafullsep.csv', 'rU'), delimiter=','))
csv2 = list(csv.reader(open('testdatafullsep.csv', 'rU'), delimiter=','))
total = [map(float, x) for x in csv1]
test = [map(float, x) for x in csv2]
...
print scaledtest1
print scaledcase0total
print scaledcase1total
...
print results
print [int(test[x][-1]) for x in range(len(test))]
